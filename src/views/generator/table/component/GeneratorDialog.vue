      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="表名" prop="tableName">
            <el-tooltip class="box-item" effect="dark" content="表名" placement="top">
        ...
        <el-col :span="12">
          <el-form-item label="说明" prop="tableComment">
            <el-tooltip class="box-item" effect="dark" content="说明" placement="top">
        ...
        <el-col :span="12">
          <el-form-item label="类名" prop="className">
            <el-tooltip class="box-item" effect="dark" content="类名如：UserEntity" placement="top">
        ...
        <el-col :span="12">
          <el-form-item label="继承" prop="baseclassId">
            <el-tooltip class="box-item" effect="dark" content="继承" placement="top">
        ...
        <el-col :span="12">
          <el-form-item label="模块名" prop="moduleName">
            <el-tooltip class="box-item" effect="dark" content="模块名如：Glume" placement="top">
        ...
        <el-col :span="12">
          <el-form-item label="功能名" prop="functionName">
            <el-tooltip class="box-item" effect="dark" content="功能名如：member" placement="top">
        ...
        <el-col :span="12">
          <el-form-item label="项目包名" prop="packageName">
            <el-tooltip class="box-item" effect="dark" content="项目包名如：com.project.net" placement="top">
        ...
        <el-col :span="12">
          <el-form-item label="版本号" prop="version">
            <el-tooltip class="box-item" effect="dark" content="版本号如：1.0.0" placement="top">
        ...
        <el-col :span="12">
          <el-form-item label="默认作者" prop="author">
            <el-tooltip class="box-item" effect="dark" content="默认作者如：TuoYingtao" placement="top">
        ...
        <el-col :span="12">
          <el-form-item label="作者邮箱" prop="email">
            <el-tooltip class="box-item" effect="dark" content="作者邮箱" placement="top">
        ...
        <el-col :span="12">
          <el-form-item label="生成方式" prop="generatorType">
            <el-tooltip class="box-item" effect="dark" content="生成方式" placement="top">
        ...
        <el-col :span="12">
          <el-form-item label="表单布局" prop="formLayout">
            <el-tooltip class="box-item" effect="dark" content="表单布局" placement="top">
        ...
        <el-col :span="24" v-show="formData.generatorType === GeneratorTypeEnum.CUSTOM_PATH">
          <el-form-item label="后端生成路径" prop="backendPath">
            <el-tooltip class="box-item" effect="dark" content="后端生成路径" placement="top">
        ...
        <el-col :span="24" v-show="formData.generatorType === GeneratorTypeEnum.CUSTOM_PATH">
          <el-form-item label="前端生成路径" prop="frontendPath">
            <el-tooltip class="box-item" effect="dark" content="前端生成路径" placement="top">
